...
This is a containerized process to query object data from The Met's API in order to generate image embeddings and load them into `art-vandelay-db`: a previously-deployed OpenSearch domain and S3 bucket for corresponding images.
